This is the firmware config as it stands now. The things that aren't working yet are the BL-Touch sensor, and that the bed heating turns off once it reaches the desired temperature.
